...
export default function MapBasemap() {
  ...
  '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a> &copy; <a href="https://openskimap.org/">OpenSkiMap.org</a>'
    ...
    return <>
        <MapContainer id="mapid" center={center} zoom={zoom}>
            <LayersControl position="topright">
                ...
                <LayersControl.BaseLayer checked name="HOT">
                    <TileLayer
                    attribution={attribution}
                ...
                <LayersControl.BaseLayer name="DARK">
                    <TileLayer
                    attribution={attribution}
                    url={basemapsDict.dark}
                    />
                </LayersControl.BaseLayer>
                <LayersControl.BaseLayer checked name="CYCLE">
                    <TileLayer
                    attribution={attribution}
                    url={basemapsDict.cycle}
                    />
                </LayersControl.BaseLayer>
            </LayersControl>
